              ...
              {!showAll && (
                <div className="rounded-2xl border border-white/60 bg-white/70 p-6 shadow-xl backdrop-blur-xl">
                  <p className="mb-2 text-sm font-semibold text-slate-900">
                    Current Step: {stepperSteps[step]}
                  </p>
                  <p className="text-sm text-slate-700">
                    {step === 0 && "Fill in basic vehicle information"}
                    {step === 1 && "Select exterior and interior colors"}
                    {step === 2 && "Specify engine and powertrain details"}
                  </p>
                </div>
              )}
