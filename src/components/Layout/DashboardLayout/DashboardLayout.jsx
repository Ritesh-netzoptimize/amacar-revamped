...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className="bg-blue-50 min-h-screen bg-gradient-hero ">
      {/* Mobile Header */}
      <a href='/' className='lg:block bg-white py-[0.9rem] px-[4rem] fixed '><img className='cursor-pointer h-10 w-32' src="src\assets\original_logo.jpg" alt="logo" /></a>
